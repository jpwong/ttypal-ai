...
def main():
    ...
    parser.add_argument("--socket", "-s", help="ttypal socket 路径 (覆盖 -b/-S)")
    ...
    from ttypal.session import find_socket
    sock_path = args.socket or find_socket(session=args.session, board=args.board)
